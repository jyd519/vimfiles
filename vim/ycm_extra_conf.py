...
def find_file_recursively(file_name, start_dir=os.getcwd(), stop_dir=None):
    """
...
def make_path_absolute(path, base_dir=os.getcwd()):
    """
...
def make_final_flags(file_name, flags, base_dir=os.getcwd()):
    """
...
def parse_clang_complete(file_name, search_base=os.getcwd()):
    """
