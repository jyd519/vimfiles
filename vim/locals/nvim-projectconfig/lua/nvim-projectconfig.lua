...
function M.find_project_root()
  local dir = fn.getcwd()
  while #dir > 0 do
    if fn.isdirectory(dir .. '/' .. '.vim')
      or fn.isdirectory(dir .. '/.git')  then
      return dir .. '/.vim/'
    end
    dir = fn.fnamemodify(dir, ":p")
  end

  -- fallback to currrent directory
  return dir .. '/.vim/'
end
...
local function load_from_directory()
    config.project_dir = M.find_project_root()
...
function M.get_config_by_ext(ext)
    ...
    return config.project_dir .. 'local.' .. ext
end
