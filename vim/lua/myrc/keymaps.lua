...
vim.keymap.set("n", "<leader>fgf", "<cmd>Telescope git_files<cr>", { desc = "Find in git files" })
vim.keymap.set("n", "<leader>fgc", "<cmd>Telescope git_commits<cr>", { desc = "Find in Git commits" })
...
vim.keymap.set("n", "<leader>fc", "<cmd>Telescope colorscheme<cr>", { desc = "List Colorschemes" })
